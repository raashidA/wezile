...
var loader = function() {
  ...
  $(".site-loader-wrap").delay(200).fadeOut("slow");
	$("#wezile_co--overlayer").delay(200).fadeOut("slow");	
}
...
var siteMenuClone = function() {
	...
	setTimeout(function() {
		...
		var counter = 0;
    $('.wezile_co--site-mobile-menu .has-children').each(function(){
      var $this = $(this);
...
var mobileToggleClick = function() {
  ...
  // click outisde offcanvas
    ...
    var container = $(".wezile_co--site-mobile-menu");
...
var onePageNavigation = function() {
  var navToggler = $('.site-menu-toggle');
 	$("body").on("click", ".wezile_co--site-nav .site-nav-ul li a[href^='#'], .smoothscroll[href^='#'], .wezile_co--site-mobile-menu .site-nav-wrap li a[href^='#']", function(e) {
	...
	$.ajax({
		...
		success: function(html) {
			...
			pSingleHolder.append(
				...
				'" class="portfolio-single-inner"><span class="wezile_co--close-portfolio js-close-portfolio d-flex align-items-center"><span class="close-portfolio-label">Back to Portfolio</span><span class="icon-close2 wrap-icon-close"></span></span>' + getHTMLContent + '</div>'
			);
...
var stickyFillPlugin = function() {
	var elements = document.querySelectorAll('.wezile_co--sticky');
